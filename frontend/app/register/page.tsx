                        ...
                        <label className="block space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    setForm((current) => ({
                                        ...current,
                                        name: sanitizeRussianNameInput(event.target.value)
                                    }));
                        ...
                        <label className="block space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    ...
                                    if (fieldErrors.email) setFieldErrors((current) => ({
                                        ...current,
                                        email: undefined
                                    }));
                                }}
                        ...
                        <label className="block space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    ...
                                    if (fieldErrors.password) setFieldErrors((current) => ({
                                        ...current,
                                        password: undefined
                                    }));
                                }}
                        ...
                        <label className="block space-y-1.5">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    ...
                                    if (fieldErrors.confirmPassword) setFieldErrors((current) => ({
                                        ...current,
