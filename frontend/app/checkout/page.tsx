            ...
            <main className="flex-1">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="flex items-center justify-between mt-4">
                                                            <div
                                                                className="flex items-center gap-1 border border-border rounded">
                                                                <button
                                                                ...
                                                                <span
                                                                    className="px-3 text-sm font-medium text-foreground">
                                  {item.quantity}
                                </span>
                                                                <button
                                                                    onClick={() => updateCartQuantity(item.product.id, item.quantity + 1)}
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    setShipping((s) => ({
                                                        ...s,
                                                        address: sanitizeRussianAddressInput(e.target.value)
                                                    }));
                                                    if (shippingErrors.address) setShippingErrors((current) => ({
                                                        ...current,
                                                        address: undefined
                                                    }));
                                                }}
                                            ...
                                            {shippingErrors.address &&
                                                <p className="mt-1 text-xs text-destructive">{shippingErrors.address}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    setPayment((current) => ({
                                                        ...current,
                                                        cardholder: sanitizeCardholderNameInput(e.target.value)
                                                    }));
                                                    if (paymentErrors.cardholder) setPaymentErrors((current) => ({
                                                        ...current,
                                            ...
                                            {paymentErrors.cardholder &&
                                                <p className="mt-1 text-xs text-destructive">{paymentErrors.cardholder}</p>}
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-foreground mb-1.5">
                                                {t.cardNumber}
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (paymentErrors.cardNumber) setPaymentErrors((current) => ({
                                                        ...current,
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        if (paymentErrors.expiry) setPaymentErrors((current) => ({
                                                            ...current,
                                                            expiry: undefined
                                                        }));
                                                    }}
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        if (paymentErrors.cvv) setPaymentErrors((current) => ({
                                                            ...current,
                                                            cvv: undefined
                                                        }));
                                                    }
                                                ...
                                                />
                                                {paymentErrors.cvv &&
                                                    <p className="mt-1 text-xs text-destructive">{paymentErrors.cvv}</p>}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <span
                            className="flex-shrink-0 w-5 h-5 rounded-full bg-muted text-xs flex items-center justify-center font-medium text-foreground">
                          {item.quantity}
                        </span>
                        ...
                        {formatPrice(item.product.price * item.quantity)}
                                ...
                                <div className="px-6 py-5 border-t border-border space-y-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span
                                            className={shippingCost === 0 ? "text-green-600 font-medium" : "text-foreground font-medium"}>
