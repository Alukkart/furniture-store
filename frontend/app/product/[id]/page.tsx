                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
                        ...
                        <div className="relative aspect-4/3 lg:aspect-square rounded-xl overflow-hidden bg-muted">
                            ...
                            {product.originalPrice && (
                                <span
                                    className="absolute top-4 left-4 bg-accent text-accent-foreground text-sm font-semibold px-3 py-1.5 rounded">
                    ...
                    {qty}
                            ...
                            <div className="mt-8 pt-8 border-t border-border grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    {
                                        icon: RotateCcw,
                                        label: siteText[locale].home.perks.returns,
                                        sub: siteText[locale].home.perks.returnsDesc
                                    },
